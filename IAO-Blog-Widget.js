...
function createWidget() {
  ...
  if (config.widgetFamily == "large") {
    ...
    let dateViewTxt = dateView.addText(
      dateFormatter.string(new Date(items[0].pubDate))
    );
...
async function getImage() {
  ...
  if (fm.fileExists(path)) {
    ...
    let iconImage = await loadImage(
      "https://www.ecofleetservices.de/wp-content/uploads/2020/10/LogoFraunhofer.png"
    );
